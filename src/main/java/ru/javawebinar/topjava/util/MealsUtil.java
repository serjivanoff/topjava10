...
public class MealsUtil {
    ...
    public static List<MealWithExceed> mealWithExceed=
            getFilteredWithExceeded(meals,LocalTime.of(0, 0), LocalTime.of(23, 59), 2000);

    public static void main(String[] args) {
//
//        mealWithExceed = getFilteredWithExceeded(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);

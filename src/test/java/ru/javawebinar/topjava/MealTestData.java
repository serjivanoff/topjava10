...
public class MealTestData {
    ...
    public static final List<MealWithExceed>MEAL_WITH_EXCEED=MealsUtil.getWithExceeded(MEALS,2000);
    public static final List<MealWithExceed>MEAL_WITH_EXCEED_CREATED=MealsUtil.getWithExceeded(
            Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1,getCreated()),2000);
